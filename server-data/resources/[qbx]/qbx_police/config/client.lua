return {
    ...
    authorizedVehicles = {
        [0] = { -- Grade 0: Cadet / Recruit
            newvic = 'Ford Crown Victoria P71 (LSPD)',
            ['14charger'] = '2014 Dodge Charger Cruiser (LSPD)',
            ['16explorer'] = '2016 Ford Explorer Utility SUV (LSPD)',
            policet = 'Police Transport Van',
        },
        [1] = { -- Grade 1: Officer / Deputy
            newvic = 'Ford Crown Victoria P71 (LSPD)',
            ['14charger'] = '2014 Dodge Charger Cruiser (LSPD)',
            ['18charger'] = '2018 Dodge Charger Interceptor (LSPD)',
            ['16explorer'] = '2016 Ford Explorer Utility SUV (LSPD)',
            ['19suburban'] = '2019 Chevy Suburban Tactical SUV',
            policeb = 'Police Patrol Motorcycle',
            policet = 'Police Transport Van',
            sp1 = 'State Police Crown Victoria',
            sp11 = 'State Police Explorer SUV',
        },
        [2] = { -- Grade 2: Senior Officer / Sergeant
            newvic = 'Ford Crown Victoria P71 (LSPD)',
            ['14charger'] = '2014 Dodge Charger Cruiser (LSPD)',
            ['18charger'] = '2018 Dodge Charger Interceptor (LSPD)',
            ['16explorer'] = '2016 Ford Explorer Utility SUV (LSPD)',
            ['19suburban'] = '2019 Chevy Suburban Tactical SUV',
            bearcat = 'SWAT Lenco Bearcat Armored Unit',
            policeb = 'Police Patrol Motorcycle',
            policet = 'Police Transport Van',
            sp1 = 'State Police Crown Victoria',
            sp7 = 'State Police 2014 Charger',
            sp9 = 'State Police 2018 Charger Interceptor',
            sp11 = 'State Police Explorer SUV',
            sp21 = 'State Police Suburban SUV',
        },
        [3] = { -- Grade 3: Lieutenant / Commander
            newvic = 'Ford Crown Victoria P71 (LSPD)',
            ['14charger'] = '2014 Dodge Charger Cruiser (LSPD)',
            ['18charger'] = '2018 Dodge Charger Interceptor (LSPD)',
            ['16explorer'] = '2016 Ford Explorer Utility SUV (LSPD)',
            ...
            sp11 = 'State Police Explorer SUV',
            sp21 = 'State Police Suburban SUV',
            polmav = 'Police Air Support Helicopter (Air One)',
        },
        [4] = { -- Grade 4: Chief of Police / Sheriff
            newvic = 'Ford Crown Victoria P71 (LSPD)',
            ['14charger'] = '2014 Dodge Charger Cruiser (LSPD)',
            ['18charger'] = '2018 Dodge Charger Interceptor (LSPD)',
            ['16explorer'] = '2016 Ford Explorer Utility SUV (LSPD)',
